...
class EditUserRequest(BaseModel):
    ...
    first_name: str | None = Field(None, min_length=1, max_length=50, description="First name must be 1-50 characters")
    last_name: str | None = Field(None, min_length=1, max_length=50, description="Last name must be 1-50 characters")
    phone_number: str | None = Field(None, min_length=10, max_length=15, description="Phone number must be 10-15 digits")
...
class ChangePasswordRequest(BaseModel):
    new_password: str = Field(..., min_length=8, max_length=100, description="Password must be 8-100 characters")
